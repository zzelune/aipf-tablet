...
import { Row, Col, Form, Card, Select, List,Button,Icon,Radio} from 'antd';
...
import styles from './ModelMarket.less';
  ...
  render() {
    ...
    return (
      <div className={styles.coverCardList}>
        <Card bordered={false}>
          <Form layout="inline">
            <StandardFormRow title="主题" block style={{ paddingBottom: 4 }}>
              <FormItem>
            ...
            <StandardFormRow title="数据类型" block style={{ paddingBottom: 4 }}>
              <FormItem>
            ...
            <StandardFormRow title="领域" block style={{ paddingBottom: 4 }}>
              <FormItem>
            ...
            <StandardFormRow title="引擎" block style={{ paddingBottom: 4 }}>
              <FormItem>
         ...
         <Col span={6}>
           <Button.Group>
             <Button>下载量<Icon type="arrow-down" /></Button>
             <Button>时间<Icon type="arrow-down" /></Button>
             <Button>名称<Icon type="arrow-down" /></Button>
           </Button.Group>
         </Col>
         <Col span={6}>
           <Radio.Group defaultValue="all">
           <Radio.Button value="all">全部</Radio.Button>
           <Radio.Button value="progress">公共</Radio.Button>
           <Radio.Button value="waiting">发布给我的</Radio.Button>
           </Radio.Group>
         </Col>
         </Row>
         </div>
